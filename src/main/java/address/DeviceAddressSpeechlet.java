...
public class DeviceAddressSpeechlet implements SpeechletV2 {
    ...
    private static final String WELCOME_TEXT = "Hallo. Ich kann dir deine aktuelle Adresse nennen.";
    private static final String HELP_TEXT = "Frage mich: Wie ist meine Adresse?";
    ...
    private SpeechletResponse getAddressResponse(String streetName, String state, String zipCode) {
        String speechText = "Deine aktuelle Adresse ist " + streetName + " " + state + ", " + zipCode;
